...
def sub_parser_add(sub_parser):
    ...
    add_parser.add_argument('-d', '--duration', type=int, help="Event duration (minutes) default: " + str(default_args['new_event_duration']), default=default_args['new_event_duration'])
